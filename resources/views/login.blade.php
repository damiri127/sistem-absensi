...
<html lang="en">
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="wrap">
						<div class="img" style="background-image: url({{asset("asset_login/login-form-15/images/header3.png")}});"></div>
  ...
  <script src="{{asset("asset_login/login-form-15/js/bootstrap.min.js")}}"></script>
  <script src="{{asset("asset_login/login-form-15/js/main.js")}}"></script>
