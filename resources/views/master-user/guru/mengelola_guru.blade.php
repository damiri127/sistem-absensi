...
@section('content')
    <div class="page-inner">
        <a href="/master-user/guru/create" class="btn btn-primary"><i class="fas fa-plus"></i>     Tambah</a>
        <div class="card mt-3">
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form id="delete-form-{{ $item->id }}" action="/master-user/guru/{{$item->id}}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
